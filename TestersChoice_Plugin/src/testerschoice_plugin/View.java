...
public class View extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		btn_load.setBounds(225, 5, 76, 25);
	...
	class FetchButtonListener implements SelectionListener {
		...
		public void widgetSelected(SelectionEvent arg0) {
			...
			testcase_class_name = activity_class+"Test";
			
			AndroidXmlSaxParser saxB = new AndroidXmlSaxParser(xmlHash.get(combo_layout_xml.getText()), "Button");
			AndroidXmlSaxParser saxE = new AndroidXmlSaxParser(xmlHash.get(combo_layout_xml.getText()), "EditText");
	...
	private void writeFile(String text){
		File file = new File("C:\\"+activity_class+"Test.java");
		try {
